  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100 font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <Header userName={isSuperAdminAuth ? "Sidra (Platform Owner)" : "Sidra"} userRole="Platform Super Admin" />
        ...
        <main className="p-8 space-y-6 flex-1 overflow-y-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-gradient-to-r from-purple-950/40 via-amber-950/20 to-slate-900 p-6 rounded-3xl border border-amber-500/30 shadow-2xl backdrop-blur-xl">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400 font-medium flex items-center gap-2">
                <Lock className="w-3.5 h-3.5 text-emerald-400" /> Platform Owner Dedicated Access • Track real-time account creations, dates, exact times, days, & months.
              </p>
            </div>
          ...
          {/* If NOT Authenticated as Super Admin: Render Lock Gatekeeper */}
          {!isSuperAdminAuth ? (
            <div className="py-12 flex justify-center">
              <div className="bg-slate-900 border border-amber-500/30 rounded-3xl p-8 max-w-md w-full shadow-2xl space-y-5 text-center relative overflow-hidden">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl font-extrabold text-white">Owner Security Verification</h3>
                  <p className="text-xs text-slate-400">Enter your Super Admin Password to unlock global platform metrics and user creation ledgers.</p>
                </div>
                ...
                <form onSubmit={handleSuperAdminLogin} className="space-y-4 text-left">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 rounded-xl bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 text-white font-bold text-xs shadow-lg hover:brightness-110 flex items-center justify-center gap-2 transition-all"
                  >
                    Unlock Super Admin Dashboard <ArrowRight className="w-4 h-4" />
                  </button>
                </form>
              </div>
            </div>
