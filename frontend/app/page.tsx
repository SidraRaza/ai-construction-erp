      ...
      <nav className="border-b border-slate-800/80 px-4 sm:px-8 py-3.5 flex items-center justify-between backdrop-blur-md bg-slate-950/90 sticky top-0 z-50">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button
            ...
            className="text-xs font-extrabold px-4 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg shadow-orange-500/20 hover:brightness-110 transition-all flex items-center gap-1.5"
          >
        ...
        <div className="flex md:hidden items-center gap-2">
          <button
            onClick={() => setIsAuthModalOpen(true)}
            className="text-[11px] font-bold text-white bg-gradient-to-r from-amber-500 to-orange-600 px-3 py-1.5 rounded-lg"
          >
            Get Started
          </button>
