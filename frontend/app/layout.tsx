  ...
  return (
    ...
    >
      <head>
        ...
        <meta itemProp="name" content="AI Construction ERP — Next-Gen Construction Management SaaS" />
        ...
        {/* Secondary JPG Fallback Image for Legacy WhatsApp & Android Scrapers */}
        <meta property="og:image" content={`${SITE_URL}/og-image.jpg`} />
        <meta property="og:image:url" content={`${SITE_URL}/og-image.jpg`} />
